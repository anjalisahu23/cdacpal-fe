<%-- 
    Document   : diot
    Created on : Dec 21, 2019, 9:19:31 PM
    Author     : nicea
--%>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">PG-DBDA</a></li>
          <li class="list-inline-item text-white h3 font-secondary @@nasted"></li>
        </ul>
        <p class="text-lighten">The theoretical and practical mix of the Post Graduate Diploma in Internet of Things (PG-DIoT) programme has the following focus:
...
Students will be able to use advanced IoT Tools/ Decision-Making Tools/ Operation Research Techniques to analyze the complex problems and get ready to develop such new techniques for the future.</p>
      </div>
    </div>
  </div>
</section>
...
<script>
   ...
   function myFunction() {    
                ...
                $.ajax({
                    type: "get",
                    url: 'http://localhost:8083/cdacpal/getcoursematerial?courseid=8',
