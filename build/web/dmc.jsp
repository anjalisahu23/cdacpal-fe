<%-- 
    Document   : dmc
    Created on : Dec 21, 2019, 9:18:26 PM
    Author     : nicea
--%>
...
<script>
   ...
   function myFunction() {    
                ...
                $.ajax({
                    type: "get",
                    url: 'http://localhost:8083/cdacpal/getcoursematerial?courseid=2',
