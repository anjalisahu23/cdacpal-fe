<%-- 
    Document   : dai
    Created on : Dec 21, 2019, 9:20:28 PM
    Author     : nicea
--%>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">PG-DAI</a></li>
          <li class="list-inline-item text-white h3 font-secondary @@nasted"></li>
        </ul>
        <p class="text-lighten">In the age of exponential growth of technologies, Data Science is driven by Machine Learning and Artificial Intelligence, which is yielding unprecedented development & insight on various technologies and business solutions. The adoption of AI is widely expanding its horizon and influencing the lives of the people and leveraging it for economic growth and social inclusion.
...
This course will have focus on AI platform, framework, infrastructure and AI based services and will give enough opportunities to the learner for business modeling, solution development, architecting automated applications, data science, coding etc</p>
      </div>
    </div>
  </div>
</section>
...
<script src="js/script.js"></script>
 ...
 <script>
   ...
   function myFunction() {    
                ...
                $.ajax({
                    type: "get",
                    url: 'http://localhost:8083/cdacpal/getcoursematerial?courseid=13',
...
//                                      
                                             ...
                                             for (var i = 0; i < response.length; i++) { 
                                              var row = $('<tr/>');    
                                               ...
                                               { 
                                                    var val = response[i][cols[colIndex]];//key->[i]:vlaue->colIndex
                                                        if(colIndex == 3)
                                                        {   
                                                            console.log("out", val)
