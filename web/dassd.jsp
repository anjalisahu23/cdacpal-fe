<%-- 
    Document   : dassd
    Created on : Dec 21, 2019, 9:20:07 PM
    Author     : nicea
--%>
...
<script src="js/script.js"></script>
 ...
 <script>
   ...
   function myFunction() {    
                ...
                $.ajax({
                    type: "get",
                   url: 'http://localhost:8083/cdacpal/getcoursematerial?courseid=11',
