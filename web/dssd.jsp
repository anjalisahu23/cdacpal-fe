<%-- 
    Document   : dssd
    Created on : Dec 21, 2019, 9:19:20 PM
    Author     : nicea
--%>
...
<script>
   ...
   function myFunction() {    
                ...
                $.ajax({
                    type: "get",
                    url: 'http://localhost:8083/cdacpal/getcoursematerial?courseid=7',
