<%-- 
    Document   : ditiss
    Created on : Dec 21, 2019, 9:19:01 PM
    Author     : nicea
--%>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">PG-DITISS</a></li>
          <li class="list-inline-item text-white h3 font-secondary @@nasted"></li>
        </ul>
        <p class="text-lighten">The theoretical and practical mix of the Post Graduate Diploma in IT Infrastructure Systems and Security  (PG-DITISS) programme has the following focus:
...
To learn the various cloud platforms to implement real time cloud applications.</p>
      </div>
    </div>
  </div>
</section>
...
<script>
   ...
   function myFunction() {    
                ...
                $.ajax({
                    type: "get",
                    url: 'http://localhost:8083/cdacpal/getcoursematerial?courseid=5',
