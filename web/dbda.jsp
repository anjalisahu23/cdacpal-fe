<%-- 
    Document   : dbda
    Created on : Dec 21, 2019, 9:19:40 PM
    Author     : nicea
--%>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        ...
        <p class="text-lighten">The theoretical and practical mix of the Post Graduate Diploma in Big Data Analytics (PG-DBDA) programme has the following focus:
...
To learn Clustering, Parallel Programming and HPC Solutions and their applications.</p>
      </div>
    </div>
  </div>
</section>
...
<script>
   ...
   function myFunction() {    
                ...
                $.ajax({
                    type: "get",
                    url: 'http://localhost:8083/cdacpal/getcoursematerial?courseid=9',
